...
def build_train_command(cfg: SmokeRunConfig) -> list[str]:
    ...
    overrides = [
        ...
        "ldf_training.formulation=windowed",
        "ldf_training.window_policy=rolling",
        f"ldf_training.context_tokens={int(cfg.context_tokens)}",
        "ldf_training.window_sampling.enabled=true",
        f"ldf_training.window_sampling.history_tokens_min={int(cfg.history_tokens_min)}",
        f"ldf_training.window_sampling.history_tokens_max={cfg.history_tokens_max}",
        f"ldf_training.window_sampling.horizon_tokens_min={int(cfg.horizon_tokens_min)}",
        f"ldf_training.window_sampling.horizon_tokens_max={int(cfg.horizon_tokens_max)}",
