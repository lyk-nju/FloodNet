...
class WanModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        Args:
            ...
            spatial_dim (`int`, *optional*, defaults to 2):
                Spatial dimension for positional encoding (0 for 0D, 1 for 1D, 2 for 2D)
        """
        ...
        if spatial_dim == 2:
            ...
            self.freqs = torch.cat(
                [
                    rope_params(1024, d - 2 * (d // 4)),
                    rope_params(1024, 2 * (d // 4)),
                ],
                dim=1,
            )
        elif spatial_dim == 0:
