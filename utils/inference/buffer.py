...
class TrajStreamBuffer:
    ...
    def get_body_traj_cond(self, *, head_state, body_anchor_state,
        ...
        from utils.inference.root_plan import slice_plan_with_mask
    ...
    def get_traj_valid_lens(
        ...
        LDF datasets now emit dense valid masks; horizon/rootplan code may still
        pass shorter contiguous masks explicitly.
