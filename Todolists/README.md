...
- **[`Task5-loss.md`](Task5-loss.md)**: Motion-space control loss — full-sequence VAE decode, supervision **only** on the active-window frame slice (aligned with diffusion MSE), axis convention `[x, z]` = indices `[0, 2]`.
