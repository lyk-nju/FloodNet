...
def _default_shards_dir() -> Path:
    """Legacy default shard directory used by eval/run_t2m_metrics.py."""
    return Path(__file__).resolve().parents[1] / "t2m_parallel_shards"


def _generation_metrics_script() -> Path:
    return Path(__file__).resolve().parent / "generation_metrics.py"
