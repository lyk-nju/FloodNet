...
eval/ldf/generation_metrics.py for each combination as a subprocess.
...
EVAL_SCRIPT = os.path.join(PROJECT_ROOT, "eval", "ldf", "generation_metrics.py")
...
def _find_metrics_json(run_out_dir: Path) -> Optional[Path]:
    ...
    # generation_metrics.py saves to: run_out_dir/eval_<exp>_<probe>_<meta>_seed<N>/metrics.json
