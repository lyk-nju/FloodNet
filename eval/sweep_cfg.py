"""Compatibility wrapper for LDF CFG sweep."""
...
from eval.ldf.sweep_cfg import *  # noqa: F401,F403
from eval.ldf.sweep_cfg import main
from eval.ldf import sweep_cfg as _compat_impl
